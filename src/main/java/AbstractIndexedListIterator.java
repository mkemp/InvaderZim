...
/**
 * Adapted from com.google.common.collect.AbstractIndexedListIterator.
 *
 * This class provides a skeletal implementation of the {@link java.util.ListIterator}
...
abstract class AbstractIndexedListIterator<E> extends UnmodifiableListIterator<E> {
     ...
     * @throws IllegalArgumentException  if {@code size} is negative
     */
    protected AbstractIndexedListIterator(final int size, int position) {
        this.size = size;
